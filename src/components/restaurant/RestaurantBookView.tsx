  ...
  return (
    <main className="min-h-screen bg-zinc-50">
      <div className="max-w-lg mx-auto px-6 py-8">
        ...
        <h1 className="text-3xl font-black tracking-tight text-zinc-900 mb-1">Asztalfoglalás</h1>
        <p className="text-zinc-500 text-sm mb-8">Válaszd ki a létszámot, dátumot és időpontot.</p>
